...
const filteredTodos = (isCompleteScreen ? completedTodos : allTodos).filter((item) =>
            ...
            <View style={toDoStyles.todoWrapper}>
                ...
                <View style={toDoStyles.btnArea}>
                    <TouchableOpacity
                        ...
                        <Text style={toDoStyles.btnText}>To Do</Text>
                    </TouchableOpacity>
                ...
                <View style={toDoStyles.searchContainer}>
                    <TextInput
                        style={toDoStyles.searchInput}
